    ...
    <div className='flex px-6 py-8 gap-5'>
        <div className='px-4 min-w-[250px] border-r-2 border-third '>
            ...
            <div className='flex flex-col gap-1 justify-start mt-4'>
                ...
                <NavLink to='/setting/mail' className={(({isActive}) => `${isActive && "bg-third text-white"} text-gray-400 hover:bg-third py-1.5 px-5 rounded font-medium text-[15px] flex items-center gap-2`)}> <MdAlternateEmail />Email</NavLink>
